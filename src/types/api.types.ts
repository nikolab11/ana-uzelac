...
export function parseFilters(
  rawFilters: Partial<ProductFilterRaw>
  ...
  if (rawFilters.sizes) {
    result.sizes = Array.isArray(rawFilters.sizes)
      ? [...new Set(rawFilters.sizes)]
      : [rawFilters.sizes];
  }
  ...
  if (
    rawFilters.sortOption &&
    SORT_OPTIONS.includes(rawFilters.sortOption as SortOption)
  ) {
