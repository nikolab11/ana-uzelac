      ...
      >
        {props.products.map((product, index) => {
          ...
          if (product.product_id === 1 && props) {
            images = [
              "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/da+-+falling+rabbit.png",
            ...
            if (!(props.products[0].product_id === 9)) {
              images = [
                "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/da+-+night sky.png",
                "https://live.staticflickr.com/65535/55074135668_9cb7ab168a_z.jpg",
              ];
            } else {
              images = [
                "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/the+magical+south+-+night+sky.png",
                "https://live.staticflickr.com/65535/55074135668_9cb7ab168a_z.jpg",
              ];
            }
            ...
            if (props.alternative) {
              images = [
                "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/9934a02f0fe3bfe8b2ca8c2601a704d688026a46.jpg",
                "https://live.staticflickr.com/65535/55074195279_803f6b487e_z.jpg",
              ];
            } else {
              images = [
                "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/da+-+lioness.png",
                "https://live.staticflickr.com/65535/55074195279_803f6b487e_z.jpg",
              ];
            }
          } else if (product.product_id === 2) {
            images = [
              "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/the+moon+rabbit+-+Wushu+Nanquan.png",
              "https://live.staticflickr.com/65535/55073939001_09a24be682_b.jpg",
            ];
          } else if (product.product_id === 4) {
            images = [
              "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/the+moon+rabbit+-+moon+rabbits.png",
              "https://live.staticflickr.com/65535/55073035812_4f274cdb88_b.jpg",
            ];
          } else if (product.product_id === 3) {
            images = [
              "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/the+moon+rabbit+-+rooftops+in+Paris.png",
              "https://live.staticflickr.com/65535/55074194129_d24ba7b407_b.jpg",
            ];
          } else if (product.product_id === 5) {
            images = [
              "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/a1877112e19ed95822268adb32c5852fa2bb3de8.jpg",
              "https://live.staticflickr.com/65535/55073036872_a63f094d19_z.jpg",
            ];
          } else if (product.product_id === 9) {
            images = [
              "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/the+magical+south+-+sky+mountains.png",
              "https://live.staticflickr.com/65535/55074135658_208ccfb55d_z.jpg",
            ];
          } else if (product.product_id === 7) {
            images = [
              "https://d1pm38pc73p1c4.cloudfront.net/ana-uzelac/homepage/the+magical+south+-+garden+day+and+night.png",
