	...
	return (
		<AppLayout>
			<div className={'px-[var(--container-padding)] py-6 text-[#444444]'}>
				<h3 className={'pb-6 text-xl text-center font-bold'}>{t('terms_conditions_header')}</h3>
				<div className={'pb-6'}>
					<span className={'font-light italic'}>{t('terms_conditions_last_updated')}</span>
				</div>
				...
				<div className={'pb-9'}>
					<h4 className={'font-bold pb-4'}>{t('personal_information_section')}</h4>
					<p dangerouslySetInnerHTML={{
